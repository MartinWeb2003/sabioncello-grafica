...
const ITEMS = [
  {
    ...
    desc: 'Izrada jelovnika koji prate identitet vašeg objekta i ostavljaju profesionalan dojam na goste. Dizajniramo i tiskamo jelovnike za restorane, kafiće i apartmane — od jednostavnih do premium izvedbi.',
    features: ['Individualni dizajn prema brendu', 'Laminirani, spiralni i tvrdouvezani jelovnici', 'Standardni i nestandardni formati (A4, A5, triptih i dr.)', 'Sezonska ažuriranja i ponovni tisak'],
  },
  {
    tag: '02 Izdvojeno', id: 'izdv-pecati', icon: 'fa-stamp',
    video: iv('pecat.mp4'),
    title: '<em>Pečati</em>',
    desc: 'Brza i precizna izrada pečata za poslovne i privatne potrebe. Izrađujemo kvalitetne pečate prilagođene vašim podacima, uz jasan otisak i dugotrajnu upotrebu.',
    features: ['Izrada pečata za tvrtke, obrte, udruge', 'Standardni pečati, datumari', 'Brza izrada i zamjena gumica', 'Različite veličine i formati'],
  },
  {
    tag: '03 Izdvojeno', id: 'izdv-trofeje', icon: 'fa-trophy',
    video: iv('trofeji.mp4'),
    title: 'Trofeji i <em>plakete</em>',
    desc: 'Izrada personaliziranih nagrada za sportske, poslovne i svečane prigode. Nudimo širok izbor trofeja, plaketa i medalja uz graviranje i UV tisak za profesionalan i trajan rezultat.',
    features: ['Sportski trofeji i pehari', 'Medalje', 'Graviranje i UV tisak', 'Korporativne nagrade i zahvalnice'],
  },
  {
    ...
    features: ['Etikete za vina i maslinova ulja', 'Etikete za med, likere i rakije', 'Vodootporni tisak', 'Mala i velika naklada'],
  },
  {
    tag: '05 Izdvojeno', id: 'izdv-pokloni', icon: 'fa-gift',
    video: iv('pp-pokloni.mp4'),
    title: 'Poslovni i personalizirani <em>pokloni</em>',
    desc: 'Brendirani pokloni i promotivni proizvodi koji ostavljaju profesionalan i trajan dojam. Izrađujemo personalizirane artikle s logotipom ili porukom, prilagođene vašem poslovanju i namjeni.',
    features: ['Poslovni pokloni s logotipom', 'Brendirani katalozi i promotivni materijali', 'Kemijske, rokovnici i blokovi', 'Kalendari'],
  },
  {
    tag: '06 Izdvojeno', id: 'izdv-vjencanja', icon: 'fa-heart',
    video: iv('vjencanje.mp4'),
    title: '<em>Vjenčanja</em>',
    desc: 'Vaš savršen dan zaslužuje savršen tiskani materijal. Dizajniramo i tiskamo sve od pozivnica i zahvalnica do oznaka za stolove, mapa za goste — sve u jedinstvenoj estetici Vašeg vjenčanja.',
    features: ['Pozivnice i zahvalnice', 'Oznake za stolove i mape gostiju', 'Naljepnice i pečati', 'Etikete za vino'],
  },
]
