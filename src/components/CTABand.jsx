...
export default function CTABand({ title, subtitle, btnText, btnHref, phone = false, plain = false }) {
  return (
    <section className={`cta-band${plain ? '' : ' cta-band--liquid'}`} aria-label="Poziv na akciju">
      {!plain && (
      ...
      <div className={`container${plain ? '' : ' cta-band__content'}`}>
