...
const SERVICES = [
  {
    ...
    features: ['Logotipi i vizualni identitet', 'Poslovne karte, letci, brošure, plakati', 'Reklamni materijali, putokazi, banneri', 'Jelovnici, cjenici'],
  },
  {
    tag: '02 Usluga', id: 'svc-tisak', icon: 'fa-print',
    video: uv('tisak.mp4'),
    title: '<em>Tisak</em>',
    desc: 'Visokokvalitetni digitalni tisak i tisak velikih formata za različite namjene. Bilo da su vam potrebne vizitke, letci, katalozi, plakati ili banneri i naljepnice velikih dimenzija — osiguravamo oštrinu, postojanost i preciznost boja u svakom projektu.',
    features: ['Digitalni tisak', 'Eco solvent tisak velikih formata', 'UV print direktno na različite materijale', 'Vizitke, letci, plakati i brošure', 'Promo materijali za događanja'],
  },
  {
    ...
    desc: 'Personalizacija tekstila za poslovne potrebe — uniforme, majice, radna odjeća i kape s vašim logotipom. Nudimo veliki izbor tekstila, uključujući majice, košulje, pregače, radnu odjeću, kape i ručnike, uz kvalitetan strojni vez i tisak koji osiguravaju dugotrajan i profesionalan izgled.',
    features: ['Strojni vez logotipa na uniforme, kape i radnu odjeću', 'Tisak na majice i druge tekstilne proizvode', 'Radna odjeća, pregače i košulje', 'Ručnici i ostali poslovni tekstil'],
  },
  {
  ...
  },
  {
    ...
    desc: 'Izrađujemo LED kanalna slova, logotipe i osvjetljene natpise koji vaš poslovni prostor čine uočljivim i profesionalnim.',
    features: ['LED kanalna slova i logotipi', 'LED reklame i svjetleći natpisi', 'Osvjetljene fasadne ploče', 'Montaža i servis'],
  },
  {
  ...
  },
  {
    ...
    desc: 'Sve što vam je potrebno za sajmove, prezentacije i svakodnevni marketing. Izrađujemo brendirane promo materijale koji vašem poslovanju daju profesionalan i uočljiv nastup.',
    features: ['Roll-up banneri', 'Promo zidovi i prezentacijski sustavi', 'Sajamski i događajni materijali', 'Brendirani materijal (upaljači, rokovnici, blokovi)'],
  },
  {
    tag: '08 Usluga', id: 'svc-laser', icon: 'fa-fire',
    video: uv('lasersko-graviranje.mp4'),
    title: 'Lasersko <em>graviranje i rezanje</em>',
    desc: 'Precizna izrada personaliziranih i poslovnih proizvoda pomoću laserske tehnologije. Radimo na različitim materijalima poput drva, akrila i plastike — idealno za natpise, oznake i brendirane proizvode.',
    features: ['Lasersko rezanje drva, akrila i plastike', 'Graviranje stakla – čaše i različitih vrsta boca', 'Natpisne pločice i oznake', 'Personalizirani i poslovni proizvodi'],
  },
  {
